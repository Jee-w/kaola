...
Pagination.prototype.jinyong=function(){
    ...
    if(pagenum2==1){
        //禁用首页和上一页
        divs[0].style.backgroundColor="#e8e8e8"
        divs[0].style.color="#bababa"
        divs[1].style.backgroundColor="#e8e8e8"
        divs[1].style.color="#bababa"
    }
    if(pagenum2==totalPage2){
        //禁用下一页和尾页
        divs[3].style.color="#bababa"
        divs[3].style.backgroundColor="#e8e8e8"
        divs[4].style.color="#bababa"
        divs[4].style.backgroundColor="#e8e8e8"
    }
}
//显示文本信息
